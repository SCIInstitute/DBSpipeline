...
if __name__ == "__main__":
    ...
    savemat(os.path.join(out_path,"Edge_data_ends.mat"),{"Ends":ends},do_compression=True)
    savemat(os.path.join(out_path,"Edge_data_tans.mat"),{"Tangents":edge_tangent},do_compression=True)
